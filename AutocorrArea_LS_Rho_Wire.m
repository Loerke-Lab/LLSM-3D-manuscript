function [autocorrAllcell] = AutocorrArea_LS_Rho_Wire(data,MovieNums,zvec)
...
close all;
fs = 16; % font size
XYsf = 0.163;% length scale factor for XY
Zsf  = 1; % length scale factor for Z
...
for mn=1:Nmovies
    ...
    %cd ..
    loaddata = load('trackingMatrixZT.mat');
